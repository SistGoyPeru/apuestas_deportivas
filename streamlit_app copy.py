...
st.title("Pronóstico y Cuotas de Apuesta ⚽")

# Valores de ejemplo para el pronóstico (probabilidades y cuotas)
prob_local = random.uniform(40.0, 60.0)
prob_empate = random.uniform(20.0, 30.0)
prob_visitante = 100 - prob_local - prob_empate

# Suponemos que tienes estas cuotas (odds) para cada resultado
# Se suelen calcular a partir de las probabilidades, por ejemplo, Cuota = 100 / Probabilidad
...
# Colores y títulos personalizados
colores = {
    "Local": "#28a745",
    "Empate": "#ffc107",
    "Visitante": "#dc3545"
